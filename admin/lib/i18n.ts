...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "queries.detail": { en: "Query detail", fr: "Détail de la requête" },
  "queries.language": { en: "Language", fr: "Langue" },
  "queries.category": { en: "Category", fr: "Catégorie" },
  "queries.apiKey": { en: "API Key", fr: "Clé API" },
  "queries.filters": { en: "Filters", fr: "Filtres" },
  "queries.applyFilters": { en: "Apply", fr: "Appliquer" },
  "queries.all": { en: "All", fr: "Tous" },
  "queries.latencyMin": { en: "Latency min (ms)", fr: "Latence min (ms)" },
  "queries.latencyMax": { en: "Latency max (ms)", fr: "Latence max (ms)" },
  "queries.chunksMin": { en: "Chunks min", fr: "Chunks min" },
  "queries.chunksMax": { en: "Chunks max", fr: "Chunks max" },
  "queries.dateFrom": { en: "From", fr: "Du" },
  "queries.dateTo": { en: "To", fr: "Au" },
