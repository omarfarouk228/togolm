"""Spider for moov-africa.tg — Moov Africa Togo (presse, offres, actualités)."""
...
_SKIP_PATH = {"/cart/", "/checkout/", "/account/", "/wp-admin/", "/wp-content/", "/feed/"}


class MoovAfricaSpider(BaseTogoSpider):
    name = "moov_africa"
    source = "moov-africa.tg"
    category = "economy"
    language = "fr"

    start_urls = [
        "https://moov-africa.tg/sitemap.xml",
        "https://moov-africa.tg/wp-sitemap.xml",
        "https://moov-africa.tg/",
        "https://moov-africa.tg/presse/",
        "https://moov-africa.tg/actualites/",
        "https://moov-africa.tg/offres/",
        "https://moov-africa.tg/mobile-money/",
        "https://moov-africa.tg/entreprise/",
    ]
    ...
    def _parse_page(self, response):
        ...
        for href in response.css("a::attr(href)").getall():
            ...
            if "moov-africa.tg" not in urlparse(url).netloc:
                continue
            if self._skip(url):
                continue
    ...
    def _extract(self, response):
        ...
        raw = (
            ...
            or self._text(response, "main p, main li, .content p, #content p, .page-content p")
        )
