...
class YasSpider(BaseTogoSpider):
    name = "yas"
    source = "yas.tg"
    category = "social"
    language = "fr"
    ...
    start_urls = [
        "https://yas.tg/sitemap.xml",
        "https://yas.tg/wp-sitemap.xml",
        "https://yas.tg/",
        "https://yas.tg/actualites/",
        "https://yas.tg/programmes/",
        "https://yas.tg/projets/",
    ]
    ...
    def _parse_page(self, response):
        ...
        for href in response.css("a::attr(href)").getall():
            ...
            if "yas.tg" not in urlparse(url).netloc:
                continue
            if self._skip(url):
                continue
