"""Spider for campus-togo.com — portail étudiant et académique togolais."""
...
_SKIP_PATH = {"/tag/", "/author/", "/feed/", "/wp-admin/", "/wp-content/", "/cart/", "/checkout/"}
_WP_DATE = re.compile(r"/\d{4}/\d{2}/\d{2}/.+")


class CampusTogoSpider(BaseTogoSpider):
    name = "campus_togo"
    source = "campus-togo.com"
    category = "education"
    language = "fr"

    start_urls = [
        "https://campus-togo.com/sitemap.xml",
        "https://campus-togo.com/wp-sitemap.xml",
        "https://campus-togo.com/",
        "https://campus-togo.com/actualites/",
        "https://campus-togo.com/concours/",
        "https://campus-togo.com/bourses/",
        "https://campus-togo.com/formations/",
        "https://campus-togo.com/orientation/",
    ]
    ...
    def _parse_page(self, response):
        ...
        for href in response.css("a::attr(href)").getall():
            ...
            if "campus-togo.com" not in urlparse(url).netloc:
                continue
            if self._skip(url):
                continue
